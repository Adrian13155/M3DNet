...
def main(opt):
    ...
    if opt.satellite == "WV2":
        ...
        channel = 4
    model = M3DNet(channel,1,32,4).cuda()
...
def get_opt():
    ...
    parser.add_argument('--exp_name', type=str, default='M3DNet', help='experiment name')
    parser.add_argument('-learning_rate', help='Set the learning rate', default=9e-4, type=float)
    parser.add_argument('-batch_size', help='批量大小', default=128, type=int)
    ...
    parser.add_argument('-save_dir', help='日志保存路径', default='/data/cjj/projects/M3DNet/experiment', type=str)
